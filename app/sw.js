const CACHE = 'tefsen-web-shell-v68-settings-permission-fix';

const SHELL = [
  './', './index.html', './manifest.webmanifest',
  './css/app.css', './css/premium.css', './css/premium-v2.css', './css/social-cleanup.css', './css/opportunities.css', './css/student-passport.css', './css/journey.css', './css/communities.css', './css/admin.css', './css/v2.css', './css/v3-polish.css', './css/v4-profile.css', './css/home-dashboard.css', './css/v25-settings.css', './css/v27-moderation.css', './css/v28-recognition.css', './css/v29-search-integrity.css', './css/light-theme.css', './css/stage1-safe.css',
  './js/app.js', './js/stage1-safe.js', './js/config/schema.js', './js/firebase-client.js', './js/store.js', './js/utils.js',
